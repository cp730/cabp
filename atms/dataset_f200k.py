...
class Fashion200K(MyDataset):
	...
	def __init__(self, split, vocab, transform, what_elements='triplet', load_image_feature=0, ** kw):
		MyDataset.__init__(self, split, FASHION200K_IMAGE_DIR,FASHION200K_ANNOTATION_DIR, vocab, transform=transform, what_elements=what_elements, load_image_feature=load_image_feature, **kw)
