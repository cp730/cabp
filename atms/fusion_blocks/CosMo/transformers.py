...
from fusion_blocks.utils.cosmo_utils import reshape_text_features_to_concat


class AttentionModule(nn.Module):
    def __init__(self, feature_size, text_feature_size, num_heads):
        super().__init__()
        ...
        self.self_att_generator = SelfAttentionMap(feature_size, num_heads)
        self.global_att_generator = GlobalCrossAttentionMap(feature_size, text_feature_size, num_heads)
...
class GlobalCrossAttentionMap(nn.Module):
    def __init__(self, feature_size, text_feature_size, num_heads, normalizer=None):
        super().__init__()
